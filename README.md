...
## 🌐 Основные роутеры
Для тестирования запросов с авторизацией необходимо:<br>
1. Перейти на http://0.0.0.0:8000/docs
2. Использовать роутер /auth/register указав email и password
3. Использовать роутер /auth/jwt/login указав username и password, которые были указаны при регистрации
4. В разделе Authorize указать username и password, нажать authorize
